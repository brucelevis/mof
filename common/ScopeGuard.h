#ifndef _SCOPEGUARD_INC_
#define _SCOPEGUARD_INC_
...
#define ON_BLOCK_EXIT(...)      ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) = MakeGuard(__VA_ARGS__);(void)ANONYMOUS_VARIABLE(scopeGuard)
#define ON_BLOCK_EXIT_OBJ(...)  ScopeGuard ANONYMOUS_VARIABLE(scopeGuard) = MakeObjGuard(__VA_ARGS__);(void)ANONYMOUS_VARIABLE(scopeGuard)
