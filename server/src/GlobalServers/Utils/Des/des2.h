/*-------------------------------------------------------------------------
	created:	2010/08/16  17:20
	filename: 	e:\Project_SVN\Server\Utils\Des\des2.h
	author:		Deeple
...
private:
        ...
        char szFCiphertextAnyLength[ANY_STR_LEN];//任意长度密文
        char szFPlaintextAnyLength[ANY_STR_LEN];//任意长度明文字符串
