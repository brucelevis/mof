...
public:
	...
	static bool ParseByte4(const char * str, UI32 & res);
...
public:
	...
	UI32 ReadByte4(const char * section, const char * key, UI32 def) const;
	...
	bool WriteByte4(const char * section, const char * key, UI32 value);
